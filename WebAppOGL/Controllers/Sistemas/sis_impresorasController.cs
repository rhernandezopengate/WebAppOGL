...
namespace WebAppOGL.Controllers.Sistemas
{
    public class sis_impresorasController : Controller
    {
        ...
        {
            return View(db.sis_impresoras.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Modelo,Modelo_Toner,Numero_Serie,Numero_Parte,MAC_Ethernet,Hostname,sis_marcas_Id,adm_sucursales_Id")] sis_impresoras sis_impresoras)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Modelo,Modelo_Toner,Numero_Serie,Numero_Parte,MAC_Ethernet,Hostname,sis_marcas_Id,adm_sucursales_Id")] sis_impresoras sis_impresoras)
        {
            if (ModelState.IsValid)
            {
